...
class DPT_DINOv2(nn.Module):
    ...
    def forward(self, x):
        ...
        print("features_tuple1: ", features[0][0].shape)
        print("features_tuple2: ", features[1][0].shape)
        print("features_tuple3: ", features[2][0].shape)
        print("features_tuple4: ", features[3][0].shape)
